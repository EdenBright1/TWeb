const BOXES_DATA = {
  ...
  gaming: {
    name: 'Gaming', emoji: '🎮',
    // Fiecare tier are imaginea sa unică
    tierImages: {
      basic:    'gaming-basic.jpg',
      standard: 'gaming-standard.jpg',
      premium:  'gaming-premium.jpg',
    },
    heroImg: 'gaming-standard.jpg',
    desc: 'Surprize pentru gameri — accesorii, merchandise și colecții exclusive din lumea jocurilor video.',
    tiers: {
      basic: {
        price: '199 MDL', products: '1–3 produse', rarity: 'Common',
        items: [
      ...
      standard: {
        price: '299 MDL', products: '3–5 produse', rarity: 'Rare',
        items: [
      ...
      premium: {
        price: '499 MDL', products: '5–8 produse', rarity: 'Epic',
        items: [
  ...
  beauty: {
    name: 'Beauty', emoji: '💄',
    tierImages: {
      basic:    'beauty-basic.jpg',
      standard: 'beauty-standard.jpg',
      premium:  'beauty-premium.jpg',
    },
    heroImg: 'beauty-standard.jpg',
    desc: 'O selecție de produse cosmetice premium și skincare — branduri internaționale și formule inovatoare.',
    tiers: {
      basic: {
        price: '199 MDL', products: '2–3 produse', rarity: 'Common',
        items: [
      ...
      premium: {
        price: '499 MDL', products: '5–7 produse', rarity: 'Epic',
        items: [
  ...
  gadget: {
    name: 'Gadget', emoji: '📱',
    tierImages: {
      basic:    'gadget-basic.jpg',
      standard: 'gadget-standard.jpg',
      premium:  'gadget-premium.jpg',
    },
    heroImg: 'gadget-standard.jpg',
    desc: 'Gadgeturi și accesorii tech de ultimă generație — produse care îți simplifică viața de zi cu zi.',
    tiers: {
      basic: {
        price: '199 MDL', products: '1–2 produse', rarity: 'Common',
        items: [
          { emoji: '📡', name: 'Tracker Bluetooth slim', desc: 'Tag de urmărire ultra-subțire — compatibil iOS și Android.', chance: 70, rarity: 'common' },
          { emoji: '🔋', name: 'Cablu 3-in-1 împletit nailon', desc: 'Cablu universal USB-C / Lightning / micro-USB, 1.2m.', chance: 75, rarity: 'common' },
          { emoji: '📱', name: 'Suport telefon birou aluminiu', desc: 'Suport telescopic din aluminiu, unghi ajustabil 360°.', chance: 60, rarity: 'common' },
          { emoji: '🔌', name: 'Adaptor USB-C compact', desc: 'Adaptor cu 3 ieșiri USB-A și PD 20W.', chance: 55, rarity: 'common' },
          { emoji: '🖥️', name: 'Set management cabluri 25 pcs', desc: 'Sistem de organizare cabluri pentru birou.', chance: 65, rarity: 'common' },
        ]
      },
      standard: {
        price: '299 MDL', products: '2–4 produse', rarity: 'Rare',
        items: [
          { emoji: '🔋', name: 'Power bank magnetic 10000mAh', desc: 'Power bank cu încărcare Magsafe și display LED de status.', chance: 52, rarity: 'rare' },
          { emoji: '🔌', name: 'Hub USB-C 7-in-1', desc: 'Hub compact cu HDMI 4K, 3×USB-A, SD card, PD 100W.', chance: 45, rarity: 'rare' },
          { emoji: '💡', name: 'Lampă LED smart touch', desc: 'Lampă cu control vocal, 16M culori și timer programabil.', chance: 42, rarity: 'rare' },
          { emoji: '🎵', name: 'Speaker Bluetooth IPX7', desc: 'Difuzor portabil waterproof, 10h autonomie, sunet 360°.', chance: 35, rarity: 'rare' },
          { emoji: '📸', name: 'Mini printer foto Bluetooth', desc: 'Printer portabil Bluetooth — hârtie termică, fără cerneală, 10 coli incluse.', chance: 28, rarity: 'rare' },
          { emoji: '⌚', name: 'Curea smartwatch premium', desc: 'Curea din piele Milano sau titan pentru Apple/Samsung Watch.', chance: 40, rarity: 'common' },
        ]
      },
      premium: {
        price: '499 MDL', products: '4–6 produse', rarity: 'Epic',
        items: [
          { emoji: '🎵', name: 'Earbuds TWS cu ANC', desc: 'Căști True Wireless cu anulare activă zgomot, autonomie 8+32h, încărcare wireless.', chance: 40, rarity: 'epic' },
  ...
  snack: {
    name: 'Snack', emoji: '🍫',
    tierImages: {
      basic:    'snack-basic.jpg',
      standard: 'snack-standard.jpg',
      premium:  'snack-premium.jpg',
    },
    heroImg: 'snack-standard.jpg',
    desc: 'O experiență culinară globală — snack-uri rare și dulciuri din întreaga lume, curate cu grijă.',
    tiers: {
      basic: {
        price: '149 MDL', products: '4–6 produse', rarity: 'Common',
        items: [
      ...
      standard: {
        price: '249 MDL', products: '7–10 produse', rarity: 'Rare',
        items: [
      ...
      premium: {
        price: '399 MDL', products: '10–15 produse', rarity: 'Epic',
        items: [
  ...
  sport: {
    ...
    tierImages: {
      basic:    'sport-basic.jpg',
      standard: 'sport-standard.jpg',
      premium:  'sport-premium.jpg',
    },
    heroImg: 'sport-standard.jpg',
    ...
    tiers: {
      ...
      standard: {
        price: '329 MDL', products: '3–5 produse', rarity: 'Rare',
        items: [
      ...
      premium: {
        price: '549 MDL', products: '5–8 produse', rarity: 'Epic',
        items: [
